...
const UserServicePathPrefix = "/twirp/github.es.user.v1.UserService/"

func (s *userServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "github.es.user.v1")
	...
	switch req.URL.Path {
	case "/twirp/github.es.user.v1.UserService/GetUser":
