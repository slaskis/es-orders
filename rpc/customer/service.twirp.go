...
/*
Package customer is a generated twirp stub package.
...
const CustomerServicePathPrefix = "/twirp/github.es.customer.v1.CustomerService/"

func (s *customerServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "github.es.customer.v1")
	...
	switch req.URL.Path {
	case "/twirp/github.es.customer.v1.CustomerService/GetCustomer":
