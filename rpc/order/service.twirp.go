...
const OrderServicePathPrefix = "/twirp/github.es.order.v1.OrderService/"

func (s *orderServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "github.es.order.v1")
	...
	switch req.URL.Path {
	case "/twirp/github.es.order.v1.OrderService/CreateOrder":
		s.serveCreateOrder(ctx, resp, req)
		return
	case "/twirp/github.es.order.v1.OrderService/AddItem":
		s.serveAddItem(ctx, resp, req)
		return
	case "/twirp/github.es.order.v1.OrderService/RemoveItem":
		s.serveRemoveItem(ctx, resp, req)
		return
	case "/twirp/github.es.order.v1.OrderService/ApproveOrder":
		s.serveApproveOrder(ctx, resp, req)
		return
	case "/twirp/github.es.order.v1.OrderService/RejectOrder":
		s.serveRejectOrder(ctx, resp, req)
		return
	case "/twirp/github.es.order.v1.OrderService/GetOrder":
...
var twirpFileDescriptor0 = []byte{
	...
	0x77, 0x9e, 0x73, 0xbe, 0xf3, 0xcd, 0x99, 0xef, 0x7c, 0x33, 0x86, 0x3f, 0x03, 0xbf, 0x5d, 0xf4,
	...
	,
}
