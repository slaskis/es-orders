...
func NewCustomerServiceProtobufClient(addr string, client *http.Client) CustomerService {
...
func (c *customerServiceProtobufClient) CreateCustomer(ctx context.Context, in *CreateCustomerRequest) (*CustomerResponse, error) {
	url := c.urlBase + CustomerServicePathPrefix + "CreateCustomer"
	out := new(CustomerResponse)
	err := doProtoRequest(ctx, c.client, url, in, out)
	return out, err
}

func (c *customerServiceProtobufClient) GetCustomer(ctx context.Context, in *GetCustomerRequest) (*CustomerResponse, error) {
	url := c.urlBase + CustomerServicePathPrefix + "GetCustomer"
	out := new(CustomerResponse)
	err := doProtoRequest(ctx, c.client, url, in, out)
	return out, err
}
...
func NewCustomerServiceJSONClient(addr string, client *http.Client) CustomerService {
...
func (c *customerServiceJSONClient) CreateCustomer(ctx context.Context, in *CreateCustomerRequest) (*CustomerResponse, error) {
	url := c.urlBase + CustomerServicePathPrefix + "CreateCustomer"
	out := new(CustomerResponse)
...
func (c *customerServiceJSONClient) GetCustomer(ctx context.Context, in *GetCustomerRequest) (*CustomerResponse, error) {
	url := c.urlBase + CustomerServicePathPrefix + "GetCustomer"
	out := new(CustomerResponse)
	err := doJSONRequest(ctx, c.client, url, in, out)
	return out, err
...
const CustomerServicePathPrefix = "/twirp/acme.CustomerService/"
...
func (s *customerServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/acme.CustomerService/CreateCustomer":
		s.serveCreateCustomer(ctx, resp, req)
		return
	case "/twirp/acme.CustomerService/GetCustomer":
...
func (s *customerServiceServer) serveCreateCustomerJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	// Call service method
	var respContent *CustomerResponse
	func() {
		defer func() {
		...
		respContent, err = s.CreateCustomer(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *CustomerResponse and nil error while calling CreateCustomer. nil responses are not supported"))
		return
	}
...
func (s *customerServiceServer) serveGetCustomerJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	func() {
		...
		respContent, err = s.GetCustomer(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *CustomerResponse and nil error while calling GetCustomer. nil responses are not supported"))
		return
	}
